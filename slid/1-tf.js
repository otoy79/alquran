...
$('#info-2').on('click', function(){
  $().msgpopup({
   time: false,
    text: "  <div class='head'>Al-Fatihah (Penutupan)</div><div class='cont'><hr> <b>Surat Al Fatihaah</b> ini melengkapi unsur-unsur pokok syari'at Islam, kemudian dijelaskan perinciannya oleh ayat-ayat Al Quran yang 113 surat berikutnya.<br><br>Persesuaian surat ini dengan surat Al Baqarah dan surat-surat sesudahnya ialah surat Al Faatihah merupakan titik-titik pembahasan yang akan diperinci dalam surat Al Baqarah dan surat-surat yang sesudahnya.<br><br>Dibahagian akhir surat Al Faatihah disebutkan permohonan hamba supaya diberi petunjuk oleh Tuhan kejalan yang lurus, sedang surat Al Baqarah dimulai dengan penunjukan <i>al Kitaab</i> (Al Quran) yang cukup sempurna sebagai pedoman menuju jalan yang dimaksudkan itu.<br><br></div> ",
    type: 'info'
  });
})
document.getElementById("srt-1").innerHTML = ' <a href="1.html#1" onClick="return noHistory(this);">1</a>       <a href="1.html#2" onClick="return noHistory(this);">2</a>       <a href="1.html#3" onClick="return noHistory(this);">3</a>       <a href="1.html#4" onClick="return noHistory(this);">4</a>        <a href="1.html#5" onClick="return noHistory(this);">5</a>       <a href="1.html#6" onClick="return noHistory(this);">6</a>       <a href="1.html#7" onClick="return noHistory(this);">7</a>  ';
